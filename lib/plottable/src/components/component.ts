...
export class Component {
  ...
  private _fixedWidth: number = 0; // Requested fixed width and height. Used if non-zero and smaller than available space.
  private _fixedHeight: number = 0;
  ...
  public fixedDimensions(width: number, height: number) : Component {
