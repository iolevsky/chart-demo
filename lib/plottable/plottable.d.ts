...
declare module Plottable {
    ...
    class Component {
        ...
        fixedDimensions(width: number, height: number): Component;
        /**
...
declare module Plottable {
    module Components {
        class Arc extends Shape {
            ...
            setSize(innerRadius: number, outerRadius: number): Arc;
            addDataset(dataset: Dataset): Arc;
            arcLabel(callback: Accessor<string>): Arc;
            computeLayout(origin?: Point, availableWidth?: number, availableHeight?: number): Arc;
            checkPointCollision(point: Point): boolean;
            renderImmediately(): Arc;
            protected _createDrawer(config: any): any;
            protected _createAnimator(): any;
            protected _sizeFromOffer(availableWidth: number, availableHeight: number): {
                width: number;
...
declare module Plottable {
    module Components {
        class Circle extends Shape {
            constructor(config: any);
            computeLayout(origin?: Point, availableWidth?: number, availableHeight?: number): Circle;
            checkPointCollision(point: Point): boolean;
            protected _createDrawer(config: any): Drawers.Circle;
            protected _sizeFromOffer(availableWidth: number, availableHeight: number): {
                width: number;
                height: number;
            };
...
declare module Plottable {
    module Plots {
        class Pie extends Plot {
             ...
             **/
            entitiesAt(queryPoint: Point, offsetAngle?: number): PlotEntity[];
            protected _propertyProjectors(): AttributeToProjector;
            ...
            protected _generateDrawSteps(): Drawers.DrawStep[];
            private _sliceIndexForPoint(p, offsetAngle);
            private _drawLabels();
        }
    }
}
...
declare module Plottable {
    module Animators {
        ...
        class Arc extends Easing {
            ...
            animate(selection: d3.Selection<any>, attrToAppliedProjector: AttributeToAppliedProjector): d3.Transition<any>;
            _pathTween(d: any, index: any, dProjector: any): (t: any) => any;
        }
    }
}
declare module Plottable {
